...
public class RemoteAccountManager implements AccountManager {
	...
	// TODO-12 We will need to make RESTful calls to the Accounts Microservice
	...
	public List<Account> getAllAccounts() {
		// TODO-13: Make a RESTful call to fetch accounts
	...
	public Account getAccount(Long id) {
		// TODO-14: Make a RESTful call to fetch an account by its id
		return null;
	}
