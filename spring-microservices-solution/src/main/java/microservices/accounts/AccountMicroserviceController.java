 ...
 */
@RestController
public class AccountMicroserviceController {

	protected Logger logger = Logger
			.getLogger(AccountMicroserviceController.class.getName());
	 ...
	 */
	@Autowired
	public AccountMicroserviceController(AccountManager accountManager) {
