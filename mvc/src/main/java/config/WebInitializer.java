...
public class WebInitializer extends AbstractAnnotationConfigDispatcherServletInitializer  {
	...
	//	Deploy this web application to the server using "Run As ... Run on Server"
	//	If no server is defined in STS (check Servers tab) ask your instructor now for help
	...
	//	We will implement missing page in the next few steps.
	//
	//  >> TROUBLESHOOTING
	//	If your application deploys successfully there should be a lot of logging in the console window
	//	If you have problems, right-click on the server in the Servers panel and select Clean ...
	//	Then right-click (again) on the server and select Clean Work Directory ...
